    ...
    return (
        <div className="h-full flex flex-col w-full bg-transparent items-center pt-5 px-4">
            <div className="flex flex-col gap-5">
                ...
                >
                    <header className="w-full flex justify-center items-center mb-[-10px] font-semibold text-2xl sm:text-4xl">
                        MY SKILLS
                    </header>
                </motion.header>
                <motion.div
                ...
                >
                    <p className="text-gray-600 w-full sm:w-2/3 font-bold text-sm sm:text-4lg text-center pb-3">
            ...
            >
                {skills.map((skill) => (
                    <button
                        ...
                        className={`flex flex-col items-center cursor-pointer focus:outline-none ${selectedSkill === skill.name ? "text-gray-800" : "text-gray-600"}`}
                    >
                        <div
